          ...
          <div className="grid lg:grid-cols-[300px_1fr] gap-[30px]">
            ...
            <div>
              <div className="lg:grid lg:grid-cols-[400px_1fr]  pb-4 px-5 gap-5 lg:gap-[30px] items-center w-full rounded hidden">
                ...
                <div className="grid grid-cols-2 md:grid-cols-[1.5fr_.8fr_.8fr] gap-5 lg:gap-3">
                    ...
                    {len > 0 ? (
                      <>
                        {dataArray?.map((item: any, i: any) => {
                          return (
                            <div
                              className="grid lg:grid-cols-[400px_1fr] border  self-start py-4 px-5 gap-5 lg:gap-[30px]  w-full rounded"
                              key={i}
                            >
                              <div className="lg:border-r pr-3">
                                ...
                                >
                                  <h3
                                    className="text-base leading-[22px] hover:text-secondary transition-all mb-0"
                                ...
                                <Link
                                  href={`/institutions/${item?.institution?.institutionSlug}`}
                                >
                                  <span className="text-primary text-sm font-semibold lg:hidden">
                                    PROVIDER
                                  </span>
                                  <span className="text-base leading-[22px] inline-block !-ml-5 mt-2 hover:text-secondary transition-all">

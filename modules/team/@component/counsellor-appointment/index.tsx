...
const TeamCounselorAppoint = ({ teamId }: any) => {
  //states
  ...
  const { data: services, isLoading: serviceLoading } =
    useGetCounsellorServicesQuery(`?teamId=${teamId}`);
  ...
  const validationSchema = Yup.object().shape({
    ...
    serviceSlug: Yup.string().required("Service is required"),
            ...
            <div className="flex flex-col gap-[15px]">
              <div>
                ...
                {errors?.name && touched?.name ? (
                  <p className="text-red-500 text-[12px] m-0">{errors?.name}</p>
                ) : null}
              </div>
              <div>
                <Field
              ...
              <div>
                <Field
                  ...
                  className="border border-[#DBDBDB] rounded-[2px] w-full px-[15px] py-[8px] focus:outline-none"
                />
                {errors?.preferredUniversity && touched?.preferredUniversity ? (
                  <p className="text-red-500 text-[12px] m-0">
              ...
              <div>
                <div className="mb-3">
                  <Select
                    ...
                    options={services}
                    value={
                      values?.serviceSlug ? values?.serviceSlug : undefined
                    }
                  />
                ...
                <div>
                  <DatePicker
                    ...
                    defaultValue={
                      values?.appointmentDate && values?.appointmentDate !== ""
              ...
              <div>
                <div>
                  <Select
                    ...
                    options={teamId && appointmentDateData ? timeZone : []}
                    value={
...
export default TeamCounselorAppoint;
